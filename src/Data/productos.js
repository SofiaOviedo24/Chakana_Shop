...
catalogoData.push ({
    ...
    precio: 100.000,
    descripción:"Aretes con líneas curvas tejidos a mano en tonos dorado,morado y blanco. Nuestros diseños son únicos y pueden ser personalizados, bajo altos estandares de calidad.",
    imagen: <img src="/imgs/12_A01.jpg" alt="Foto de Aretes morado, blanco y dorado con formas triangulares." />,
    categoria: "Aretes",
});
catalogoData.push ({
    id:2,
    ...
    precio: 100.000,
    descripción:"Aretes con líneas curvas tejidos a mano en tonos azul, gris, negro, dorado y blanco. Nuestros diseños son únicos y pueden ser personalizados, bajo altos estandares de calidad.",
    imagen: <img src="/imgs/13_A02.jpg" alt="Foto de Aretes azul, gris, negro, dorado y blanco con formas triangulares." />,
    categoria: "Aretes",
});
catalogoData.push ({
    id:A_03,
    ...
    imagen: <img src="/imgs/14_A03.jpg" alt="Foto de Aretes en tono azules, verde, amarillo, rojo, naranja, rosa y plateado con forma de pluma de pavo real." />,
    categoria: "Aretes",
});
catalogoData.push ({
    id:A_04,
    ...
    imagen: <img src="/imgs/15_A04.jpg" alt="Foto de Aretes en tono azules, amarillo, rojo, naranja, negro y plateado con formas triangulares."/>,
    categoria: "Aretes",
});
catalogoData.push ({
    id:B_01,
    ...
    imagen: <img src="/imgs/16_B01.jpg" alt="Foto de Pulsera en tono azules y plateados."/>,
    categoria: "Pulseras",
});
catalogoData.push ({
    id:B_02,
    ...
    imagen: <img src="/imgs/17_B02.jpg" alt="Foto de Pulsera morados, fucsia, verde, negro y amarillo con figuras de rombos."/>,
    categoria: "Pulseras",
});
catalogoData.push ({
    id:B_03,
    ...
    imagen: <img src="/imgs/18_B03.jpg" alt="Foto de Pulsera en tono rosa, naranja y dorado con figuras de cruz."/>,
    categoria: "Pulseras",
});
catalogoData.push ({
    id:B_04,
    ...
    imagen: <img src="/imgs/19_B04.jpg" alt="Foto de Pulsera en tono azules, morados, naranja, amarillo, rojo, blanco, gris y negro con figura de cruz"/>,
    categoria: "Pulseras",
});
catalogoData.push ({
    id:C_01,
    ...
    imagen: <img src="/imgs/20_C01.jpg" alt="Foto de Cinturon en tono azules, verdes, naranja, y amarillo con figura en rombos y triangulos."/>,
...
catalogoData.push ({
    ...
    imagen: <img src="/imgs/21_C02.jpg" alt="Foto de Cinturon en tono azules, rojo, naranja, amarillo, blanco y cafe con figuras circulares y lineas diagonales."/>,
    categoria: "Cinturones",
});
catalogoData.push ({
    id:C_03,
    ...
    imagen: <img src="/imgs/22_C03.jpg" alt="Foto de Cinturon en tono azules, rojo, naranja, amarillo y blanco con figuras circulares y lineas diagonales."/>,
    categoria: "Cinturones",
});
catalogoData.push ({
    id:C_04,
    ...
    imagen: <img src="/imgs/23_C04.jpg" alt="Foto de Cinturon en tono azules, rojo, naranja, amarillo, blanco y cafe con lineas diagonales."/>,
    categoria: "Cinturones",
});
catalogoData.push ({
    id:S_01,
    ...
    imagen: <img src="/imgs/24_S01.jpg" alt="Foto de Strap para guitarra en tono amarillos, rojo, naranja, blanco y negro con lineas diagonales formando triangulos."/>,
    categoria: "Straps",
});
...
catalogoData.push ({
    ...
    imagen: <img src="/imgs/25_S02.jpg" alt="Foto de Strap para guitarra en tono rojos, naranja, verde, azules, morado y blanco con lineas diagonales formando triangulos y cruces."/>,
    categoria: "Straps",
});
catalogoData.push ({
    id:S_03,
    ...
    imagen: <img src="/imgs/26_S03.jpg" alt="Foto de Strap para guitarra en tono rojo, amarillo, naranja, verde, azules, morado y negro con lineas diagonales."/>,
    categoria: "Straps",
});
catalogoData.push ({
    id:S_04,
    ...
    imagen: <img src="/imgs/27_S04.jpg" alt="Foto de Strap para guitarra en tono rojos, azules, amarillo, beige y blanco con lineas diagonales formando triangulos."/>,
    categoria: "Straps",
});
catalogoData.push ({
    id:SC_01,
    ...
    imagen: <img src="/imgs/28_SC05.jpg" alt="Foto de Strap para cámara en tono  rojos, azul aguamarina, amarillo, morado, beige y blanco con lineas diagonales formando triangulos."/>,
    categoria: "Straps",
});
catalogoData.push ({
    id:SC_02,
    ...
    imagen: <img src="/imgs/29_SC02.jpg" alt="Foto de Strap para cámara en tonos azules, amarillo, naranja, blanco beige y cafe con lineas diagonales."/>,
    categoria: "Straps",
});
